 ...
 *
 * Only trips which pickup from the origin stop and drop off at the destination stop are shown. Trips which require
 * flagging/signaling an operator or calling an agency will be denoted as such alongside the schedule times.
 */
